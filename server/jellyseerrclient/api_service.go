...
type ApiServiceRadarrGetRequest struct {
	ctx context.Context
	ApiService *ServiceAPIService
}

func (r ApiServiceRadarrGetRequest) Execute() ([]RadarrSettings, *http.Response, error) {
...
Returns a list of Radarr server IDs and names in a JSON object.
 ...
 @return ApiServiceRadarrGetRequest
*/
func (a *ServiceAPIService) ServiceRadarrGet(ctx context.Context) ApiServiceRadarrGetRequest {
	return ApiServiceRadarrGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ServiceAPIService) ServiceRadarrGetExecute(r ApiServiceRadarrGetRequest) ([]RadarrSettings, *http.Response, error) {
	var (
...
type ApiServiceRadarrRadarrIdGetRequest struct {
	ctx context.Context
	ApiService *ServiceAPIService
	radarrId float32
}

func (r ApiServiceRadarrRadarrIdGetRequest) Execute() (*ServiceRadarrRadarrIdGet200Response, *http.Response, error) {
...
Returns a Radarr server's quality profile and root folder details in a JSON object.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param radarrId
 @return ApiServiceRadarrRadarrIdGetRequest
*/
func (a *ServiceAPIService) ServiceRadarrRadarrIdGet(ctx context.Context, radarrId float32) ApiServiceRadarrRadarrIdGetRequest {
	return ApiServiceRadarrRadarrIdGetRequest{
		ApiService: a,
		ctx: ctx,
		radarrId: radarrId,
...
func (a *ServiceAPIService) ServiceRadarrRadarrIdGetExecute(r ApiServiceRadarrRadarrIdGetRequest) (*ServiceRadarrRadarrIdGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiServiceSonarrGetRequest struct {
	ctx context.Context
	ApiService *ServiceAPIService
}

func (r ApiServiceSonarrGetRequest) Execute() ([]SonarrSettings, *http.Response, error) {
...
Returns a list of Sonarr server IDs and names in a JSON object.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiServiceSonarrGetRequest
*/
func (a *ServiceAPIService) ServiceSonarrGet(ctx context.Context) ApiServiceSonarrGetRequest {
	return ApiServiceSonarrGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ServiceAPIService) ServiceSonarrGetExecute(r ApiServiceSonarrGetRequest) ([]SonarrSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiServiceSonarrLookupTmdbIdGetRequest struct {
	ctx context.Context
	ApiService *ServiceAPIService
	tmdbId float32
}

func (r ApiServiceSonarrLookupTmdbIdGetRequest) Execute() ([]SonarrSeries, *http.Response, error) {
...
Returns a list of series returned by searching for the name in Sonarr.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param tmdbId
 @return ApiServiceSonarrLookupTmdbIdGetRequest
*/
func (a *ServiceAPIService) ServiceSonarrLookupTmdbIdGet(ctx context.Context, tmdbId float32) ApiServiceSonarrLookupTmdbIdGetRequest {
	return ApiServiceSonarrLookupTmdbIdGetRequest{
		ApiService: a,
		ctx: ctx,
		tmdbId: tmdbId,
...
// Execute executes the request
//  @return []SonarrSeries
func (a *ServiceAPIService) ServiceSonarrLookupTmdbIdGetExecute(r ApiServiceSonarrLookupTmdbIdGetRequest) ([]SonarrSeries, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiServiceSonarrSonarrIdGetRequest struct {
	ctx context.Context
	ApiService *ServiceAPIService
	sonarrId float32
}

func (r ApiServiceSonarrSonarrIdGetRequest) Execute() (*ServiceSonarrSonarrIdGet200Response, *http.Response, error) {
...
Returns a Sonarr server's quality profile and root folder details in a JSON object.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param sonarrId
 @return ApiServiceSonarrSonarrIdGetRequest
*/
func (a *ServiceAPIService) ServiceSonarrSonarrIdGet(ctx context.Context, sonarrId float32) ApiServiceSonarrSonarrIdGetRequest {
	return ApiServiceSonarrSonarrIdGetRequest{
		ApiService: a,
		ctx: ctx,
		sonarrId: sonarrId,
...
func (a *ServiceAPIService) ServiceSonarrSonarrIdGetExecute(r ApiServiceSonarrSonarrIdGetRequest) (*ServiceSonarrSonarrIdGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
