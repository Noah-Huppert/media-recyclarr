...
// GetMediaServerType returns the MediaServerType field value if set, zero value otherwise.
func (o *MainSettings) GetMediaServerType() float32 {
	if o == nil || IsNil(o.MediaServerType) {
		var ret float32
		return ret
	}
	return *o.MediaServerType
}

// GetMediaServerTypeOk returns a tuple with the MediaServerType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MainSettings) GetMediaServerTypeOk() (*float32, bool) {
	if o == nil || IsNil(o.MediaServerType) {
		return nil, false
	}
	return o.MediaServerType, true
}
...
// SetMediaServerType gets a reference to the given float32 and assigns it to the MediaServerType field.
...
func (o MainSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MediaServerType) {
		toSerialize["mediaServerType"] = o.MediaServerType
	}
