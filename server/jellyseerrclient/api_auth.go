...
/*
AuthJellyfinPost Sign in using a Jellyfin username and password
...
func (a *AuthAPIService) AuthJellyfinPostExecute(r ApiAuthJellyfinPostRequest) (*User, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthAPIService.AuthJellyfinPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/auth/jellyfin"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.authJellyfinPostRequest == nil {
		return localVarReturnValue, nil, reportError("authJellyfinPostRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.authJellyfinPostRequest
