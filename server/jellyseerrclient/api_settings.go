...
*/
func (a *SettingsAPIService) SettingsDiscoverSliderIdPut(ctx context.Context, sliderId float32) ApiSettingsDiscoverSliderIdPutRequest {
	return ApiSettingsDiscoverSliderIdPutRequest{
		ApiService: a,
		ctx: ctx,
		sliderId: sliderId,
...
type ApiSettingsJellyfinGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiSettingsJellyfinGetRequest) Execute() (*JellyfinSettings, *http.Response, error) {
...
Retrieves current Jellyfin settings.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsJellyfinGetRequest
*/
func (a *SettingsAPIService) SettingsJellyfinGet(ctx context.Context) ApiSettingsJellyfinGetRequest {
	return ApiSettingsJellyfinGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsJellyfinGetExecute(r ApiSettingsJellyfinGetRequest) (*JellyfinSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSettingsJellyfinLibraryGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	sync *string
	enable *string
...
func (r ApiSettingsJellyfinLibraryGetRequest) Sync(sync string) ApiSettingsJellyfinLibraryGetRequest {
	r.sync = &sync
	return r
}

// Comma separated list of libraries to enable. Any libraries not passed will be disabled!
func (r ApiSettingsJellyfinLibraryGetRequest) Enable(enable string) ApiSettingsJellyfinLibraryGetRequest {
	r.enable = &enable
	return r
}

func (r ApiSettingsJellyfinLibraryGetRequest) Execute() ([]JellyfinLibrary, *http.Response, error) {
...
Returns a list of Jellyfin libraries in a JSON array.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsJellyfinLibraryGetRequest
*/
func (a *SettingsAPIService) SettingsJellyfinLibraryGet(ctx context.Context) ApiSettingsJellyfinLibraryGetRequest {
	return ApiSettingsJellyfinLibraryGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsJellyfinLibraryGetExecute(r ApiSettingsJellyfinLibraryGetRequest) ([]JellyfinLibrary, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSettingsJellyfinPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	jellyfinSettings *JellyfinSettings
}

func (r ApiSettingsJellyfinPostRequest) JellyfinSettings(jellyfinSettings JellyfinSettings) ApiSettingsJellyfinPostRequest {
	r.jellyfinSettings = &jellyfinSettings
	return r
}

func (r ApiSettingsJellyfinPostRequest) Execute() (*JellyfinSettings, *http.Response, error) {
...
Updates Jellyfin settings with the provided values.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsJellyfinPostRequest
*/
func (a *SettingsAPIService) SettingsJellyfinPost(ctx context.Context) ApiSettingsJellyfinPostRequest {
	return ApiSettingsJellyfinPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return JellyfinSettings
func (a *SettingsAPIService) SettingsJellyfinPostExecute(r ApiSettingsJellyfinPostRequest) (*JellyfinSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSettingsJellyfinSyncGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r ApiSettingsJellyfinSyncGetRequest) Execute() (*SettingsJellyfinSyncGet200Response, *http.Response, error) {
...
Returns sync progress in a JSON array.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsJellyfinSyncGetRequest
*/
func (a *SettingsAPIService) SettingsJellyfinSyncGet(ctx context.Context) ApiSettingsJellyfinSyncGetRequest {
	return ApiSettingsJellyfinSyncGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsJellyfinSyncGetExecute(r ApiSettingsJellyfinSyncGetRequest) (*SettingsJellyfinSyncGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type ApiSettingsJellyfinSyncPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	settingsJellyfinSyncPostRequest *SettingsJellyfinSyncPostRequest
}

func (r ApiSettingsJellyfinSyncPostRequest) SettingsJellyfinSyncPostRequest(settingsJellyfinSyncPostRequest SettingsJellyfinSyncPostRequest) ApiSettingsJellyfinSyncPostRequest {
	r.settingsJellyfinSyncPostRequest = &settingsJellyfinSyncPostRequest
	return r
}

func (r ApiSettingsJellyfinSyncPostRequest) Execute() (*SettingsJellyfinSyncGet200Response, *http.Response, error) {
...
Runs a full Jellyfin library sync and returns the progress in a JSON array.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSettingsJellyfinSyncPostRequest
*/
func (a *SettingsAPIService) SettingsJellyfinSyncPost(ctx context.Context) ApiSettingsJellyfinSyncPostRequest {
	return ApiSettingsJellyfinSyncPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SettingsJellyfinSyncGet200Response
func (a *SettingsAPIService) SettingsJellyfinSyncPostExecute(r ApiSettingsJellyfinSyncPostRequest) (*SettingsJellyfinSyncGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SettingsAPIService) SettingsJellyfinUsersGet(ctx context.Context) ApiSettingsJellyfinUsersGetRequest {
	return ApiSettingsJellyfinUsersGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsJellyfinUsersGetExecute(r ApiSettingsJellyfinUsersGetRequest) ([]SettingsJellyfinUsersGet200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiSettingsPlexSyncPostRequest) SettingsJellyfinSyncPostRequest(settingsJellyfinSyncPostRequest SettingsJellyfinSyncPostRequest) ApiSettingsPlexSyncPostRequest {
	r.settingsJellyfinSyncPostRequest = &settingsJellyfinSyncPostRequest
	return r
}
