...
*/
func (a *SettingsAPIService) SettingsDiscoverSliderIdPut(ctx context.Context, sliderId float32) SettingsAPISettingsDiscoverSliderIdPutRequest {
	return SettingsAPISettingsDiscoverSliderIdPutRequest{
		ApiService: a,
		ctx: ctx,
		sliderId: sliderId,
...
type SettingsAPISettingsJellyfinGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r SettingsAPISettingsJellyfinGetRequest) Execute() (*JellyfinSettings, *http.Response, error) {
	return r.ApiService.SettingsJellyfinGetExecute(r)
}

/*
SettingsJellyfinGet Get Jellyfin settings

Retrieves current Jellyfin settings.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SettingsAPISettingsJellyfinGetRequest
*/
func (a *SettingsAPIService) SettingsJellyfinGet(ctx context.Context) SettingsAPISettingsJellyfinGetRequest {
	return SettingsAPISettingsJellyfinGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsJellyfinGetExecute(r SettingsAPISettingsJellyfinGetRequest) (*JellyfinSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *JellyfinSettings
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsJellyfinGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/jellyfin"
...
type SettingsAPISettingsJellyfinLibraryGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	sync *string
	enable *string
...
func (r SettingsAPISettingsJellyfinLibraryGetRequest) Sync(sync string) SettingsAPISettingsJellyfinLibraryGetRequest {
	r.sync = &sync
	return r
}

// Comma separated list of libraries to enable. Any libraries not passed will be disabled!
func (r SettingsAPISettingsJellyfinLibraryGetRequest) Enable(enable string) SettingsAPISettingsJellyfinLibraryGetRequest {
	r.enable = &enable
	return r
}

func (r SettingsAPISettingsJellyfinLibraryGetRequest) Execute() ([]JellyfinLibrary, *http.Response, error) {
	return r.ApiService.SettingsJellyfinLibraryGetExecute(r)
}

/*
SettingsJellyfinLibraryGet Get Jellyfin libraries

Returns a list of Jellyfin libraries in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SettingsAPISettingsJellyfinLibraryGetRequest
*/
func (a *SettingsAPIService) SettingsJellyfinLibraryGet(ctx context.Context) SettingsAPISettingsJellyfinLibraryGetRequest {
	return SettingsAPISettingsJellyfinLibraryGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsJellyfinLibraryGetExecute(r SettingsAPISettingsJellyfinLibraryGetRequest) ([]JellyfinLibrary, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []JellyfinLibrary
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsJellyfinLibraryGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/jellyfin/library"
...
type SettingsAPISettingsJellyfinPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	jellyfinSettings *JellyfinSettings
}

func (r SettingsAPISettingsJellyfinPostRequest) JellyfinSettings(jellyfinSettings JellyfinSettings) SettingsAPISettingsJellyfinPostRequest {
	r.jellyfinSettings = &jellyfinSettings
	return r
}

func (r SettingsAPISettingsJellyfinPostRequest) Execute() (*JellyfinSettings, *http.Response, error) {
	return r.ApiService.SettingsJellyfinPostExecute(r)
}

/*
SettingsJellyfinPost Update Jellyfin settings

Updates Jellyfin settings with the provided values.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SettingsAPISettingsJellyfinPostRequest
*/
func (a *SettingsAPIService) SettingsJellyfinPost(ctx context.Context) SettingsAPISettingsJellyfinPostRequest {
	return SettingsAPISettingsJellyfinPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return JellyfinSettings
func (a *SettingsAPIService) SettingsJellyfinPostExecute(r SettingsAPISettingsJellyfinPostRequest) (*JellyfinSettings, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsJellyfinPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.jellyfinSettings == nil {
		return localVarReturnValue, nil, reportError("jellyfinSettings is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.jellyfinSettings
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type SettingsAPISettingsJellyfinSyncGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r SettingsAPISettingsJellyfinSyncGetRequest) Execute() (*SettingsJellyfinSyncGet200Response, *http.Response, error) {
	return r.ApiService.SettingsJellyfinSyncGetExecute(r)
}

/*
SettingsJellyfinSyncGet Get status of full Jellyfin library sync

Returns sync progress in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SettingsAPISettingsJellyfinSyncGetRequest
*/
func (a *SettingsAPIService) SettingsJellyfinSyncGet(ctx context.Context) SettingsAPISettingsJellyfinSyncGetRequest {
	return SettingsAPISettingsJellyfinSyncGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsJellyfinSyncGetExecute(r SettingsAPISettingsJellyfinSyncGetRequest) (*SettingsJellyfinSyncGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SettingsJellyfinSyncGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsJellyfinSyncGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/jellyfin/sync"
...
type SettingsAPISettingsJellyfinSyncPostRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
	settingsJellyfinSyncPostRequest *SettingsJellyfinSyncPostRequest
}

func (r SettingsAPISettingsJellyfinSyncPostRequest) SettingsJellyfinSyncPostRequest(settingsJellyfinSyncPostRequest SettingsJellyfinSyncPostRequest) SettingsAPISettingsJellyfinSyncPostRequest {
	r.settingsJellyfinSyncPostRequest = &settingsJellyfinSyncPostRequest
	return r
}

func (r SettingsAPISettingsJellyfinSyncPostRequest) Execute() (*SettingsJellyfinSyncGet200Response, *http.Response, error) {
	return r.ApiService.SettingsJellyfinSyncPostExecute(r)
}

/*
SettingsJellyfinSyncPost Start full Jellyfin library sync

Runs a full Jellyfin library sync and returns the progress in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SettingsAPISettingsJellyfinSyncPostRequest
*/
func (a *SettingsAPIService) SettingsJellyfinSyncPost(ctx context.Context) SettingsAPISettingsJellyfinSyncPostRequest {
	return SettingsAPISettingsJellyfinSyncPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SettingsJellyfinSyncGet200Response
func (a *SettingsAPIService) SettingsJellyfinSyncPostExecute(r SettingsAPISettingsJellyfinSyncPostRequest) (*SettingsJellyfinSyncGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsJellyfinSyncPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.settingsJellyfinSyncPostRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type SettingsAPISettingsJellyfinUsersGetRequest struct {
	ctx context.Context
	ApiService *SettingsAPIService
}

func (r SettingsAPISettingsJellyfinUsersGetRequest) Execute() ([]SettingsJellyfinUsersGet200ResponseInner, *http.Response, error) {
	return r.ApiService.SettingsJellyfinUsersGetExecute(r)
}

/*
SettingsJellyfinUsersGet Get Jellyfin Users

Returns a list of Jellyfin Users in a JSON array.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SettingsAPISettingsJellyfinUsersGetRequest
*/
func (a *SettingsAPIService) SettingsJellyfinUsersGet(ctx context.Context) SettingsAPISettingsJellyfinUsersGetRequest {
	return SettingsAPISettingsJellyfinUsersGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SettingsAPIService) SettingsJellyfinUsersGetExecute(r SettingsAPISettingsJellyfinUsersGetRequest) ([]SettingsJellyfinUsersGet200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []SettingsJellyfinUsersGet200ResponseInner
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SettingsAPIService.SettingsJellyfinUsersGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/settings/jellyfin/users"
...
func (r SettingsAPISettingsPlexSyncPostRequest) SettingsJellyfinSyncPostRequest(settingsJellyfinSyncPostRequest SettingsJellyfinSyncPostRequest) SettingsAPISettingsPlexSyncPostRequest {
	r.settingsJellyfinSyncPostRequest = &settingsJellyfinSyncPostRequest
	return r
}
