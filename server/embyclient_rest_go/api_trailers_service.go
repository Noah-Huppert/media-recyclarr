...
/*
TrailersServiceApiService Finds movies and trailers similar to a given trailer.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TrailersServiceApiGetTrailersOpts - Optional Parameters:
...
func (a *TrailersServiceApiService) GetTrailers(ctx context.Context, localVarOptionals *TrailersServiceApiGetTrailersOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Trailers"
