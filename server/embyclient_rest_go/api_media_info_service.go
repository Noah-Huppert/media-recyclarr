...
/*
MediaInfoServiceApiService Gets live playback media info for an item
...
func (a *MediaInfoServiceApiService) GetItemsByIdPlaybackinfo(ctx context.Context, id string, userId string) (PlaybackInfoResponse, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/PlaybackInfo"
...
func (a *MediaInfoServiceApiService) PostLivestreamsMediainfo(ctx context.Context, liveStreamId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/LiveStreams/MediaInfo"
...
/*
MediaInfoServiceApiService Opens a media source
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
