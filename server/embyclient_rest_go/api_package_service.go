...
/*
PackageServiceApiService Cancels a package installation
...
func (a *PackageServiceApiService) DeletePackagesInstallingById(ctx context.Context, id string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Packages/Installing/{Id}"
...
/*
PackageServiceApiService Gets available packages
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PackageServiceApiGetPackagesOpts - Optional Parameters:
     * @param "PackageType" (optional.String) -  Optional package type filter (System/UserInstalled)
...
func (a *PackageServiceApiService) GetPackages(ctx context.Context, localVarOptionals *PackageServiceApiGetPackagesOpts) ([]PackageInfo, *http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.PackageType.IsSet() {
		localVarQueryParams.Add("PackageType", parameterToString(localVarOptionals.PackageType.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.TargetSystems.IsSet() {
		localVarQueryParams.Add("TargetSystems", parameterToString(localVarOptionals.TargetSystems.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.IsPremium.IsSet() {
		localVarQueryParams.Add("IsPremium", parameterToString(localVarOptionals.IsPremium.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.IsAdult.IsSet() {
		localVarQueryParams.Add("IsAdult", parameterToString(localVarOptionals.IsAdult.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
PackageServiceApiService Gets a package, by name or assembly guid
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
PackageServiceApiService Gets available package updates for currently installed packages
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *PackageServiceApiService) GetPackagesUpdates(ctx context.Context, packageType string) ([]PackageVersionInfo, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Packages/Updates"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	localVarQueryParams.Add("PackageType", parameterToString(packageType, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
PackageServiceApiService Installs a package
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *PackageServiceApiService) PostPackagesInstalledByName(ctx context.Context, name string, localVarOptionals *PackageServiceApiPostPackagesInstalledByNameOpts) (*http.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.UpdateClass.IsSet() {
		localVarQueryParams.Add("UpdateClass", parameterToString(localVarOptionals.UpdateClass.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
func (a *PackageServiceApiService) PostPackagesInstallingByIdDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Packages/Installing/{Id}/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
