...
/*
LocalizationServiceApiService Gets known countries
...
func (a *LocalizationServiceApiService) GetLocalizationCountries(ctx context.Context) ([]GlobalizationCountryInfo, *http.Response, error) {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []GlobalizationCountryInfo
...
/*
LocalizationServiceApiService Gets known cultures
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
LocalizationServiceApiService Gets localization options
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *LocalizationServiceApiService) GetLocalizationOptions(ctx context.Context) ([]GlobalizationLocalizatonOption, *http.Response, error) {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []GlobalizationLocalizatonOption
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
LocalizationServiceApiService Gets known parental ratings
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
