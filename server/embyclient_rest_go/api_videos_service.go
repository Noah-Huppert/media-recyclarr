...
/*
VideosServiceApiService Removes alternate video sources.
...
func (a *VideosServiceApiService) DeleteVideosByIdAlternatesources(ctx context.Context, id string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Videos/{Id}/AlternateSources"
...
func (a *VideosServiceApiService) PostVideosByIdAlternatesourcesDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Videos/{Id}/AlternateSources/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
VideosServiceApiService Merges videos into a single record
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *VideosServiceApiPostVideosMergeversionsOpts - Optional Parameters:
     * @param "Ids" (optional.String) -  Item id list. This allows multiple, comma delimited.
