...
/*
GameGenresServiceApiService Gets all Game genres from a given item, folder, or the entire library
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GameGenresServiceApiGetGamegenresOpts - Optional Parameters:
...
func (a *GameGenresServiceApiService) GetGamegenres(ctx context.Context, localVarOptionals *GameGenresServiceApiGetGamegenresOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/GameGenres"
...
/*
GameGenresServiceApiService Gets a Game genre, by name
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name The genre name
 * @param optional nil or *GameGenresServiceApiGetGamegenresByNameOpts - Optional Parameters:
...
func (a *GameGenresServiceApiService) GetGamegenresByName(ctx context.Context, name string, localVarOptionals *GameGenresServiceApiGetGamegenresByNameOpts) (BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/GameGenres/{Name}"
