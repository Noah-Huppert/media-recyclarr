...
/*
DlnaServiceApiService Deletes a profile
...
func (a *DlnaServiceApiService) DeleteDlnaProfilesById(ctx context.Context, id string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Dlna/Profiles/{Id}"
...
/*
DlnaServiceApiService Gets a single profile
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Profile Id
@return DlnaProfilesDlnaProfile
...
/*
DlnaServiceApiService Creates a profile
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
DlnaServiceApiService Updates a profile
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body DlnaProfile: 
 * @param id
