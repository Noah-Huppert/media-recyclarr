...
/*
SyncServiceApiService Cancels items from a sync target
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param targetId TargetId
 * @param optional nil or *SyncServiceApiDeleteSyncByTargetidItemsOpts - Optional Parameters:
...
func (a *SyncServiceApiService) DeleteSyncByTargetidItems(ctx context.Context, targetId string, localVarOptionals *SyncServiceApiDeleteSyncByTargetidItemsOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Sync/{TargetId}/Items"
	...
	if localVarOptionals != nil && localVarOptionals.ItemIds.IsSet() {
		localVarQueryParams.Add("ItemIds", parameterToString(localVarOptionals.ItemIds.Value(), ""))
	}
...
/*
SyncServiceApiService Cancels a sync job item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Id
...
func (a *SyncServiceApiService) DeleteSyncJobitemsById(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems/{Id}"
...
/*
SyncServiceApiService Cancels a sync job.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Id
...
func (a *SyncServiceApiService) DeleteSyncJobsById(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/Jobs/{Id}"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
SyncServiceApiService Gets ready to download sync items.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param targetId TargetId
@return []SyncedItem
...
func (a *SyncServiceApiService) GetSyncItemsReady(ctx context.Context, targetId string) ([]SyncedItem, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/Items/Ready"
...
func (a *SyncServiceApiService) GetSyncJobitems(ctx context.Context, targetId string) (QueryResultSyncJobItem, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems"
...
/*
SyncServiceApiService Gets a sync job item file
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Id
 * @param name Name
...
func (a *SyncServiceApiService) GetSyncJobitemsByIdAdditionalfiles(ctx context.Context, id string, name string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems/{Id}/AdditionalFiles"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *SyncServiceApiService) GetSyncJobitemsByIdFile(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems/{Id}/File"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *SyncServiceApiService) GetSyncJobs(ctx context.Context) (QueryResultSyncJob, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/Jobs"
...
/*
SyncServiceApiService Gets a sync job.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Id
@return SyncJob
...
/*
SyncServiceApiService Gets a list of available sync targets.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId UserId
 * @param optional nil or *SyncServiceApiGetSyncOptionsOpts - Optional Parameters:
     * @param "ItemIds" (optional.String) -  ItemIds
...
func (a *SyncServiceApiService) GetSyncOptions(ctx context.Context, userId string, localVarOptionals *SyncServiceApiGetSyncOptionsOpts) (SyncDialogOptions, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/Options"
...
func (a *SyncServiceApiService) GetSyncTargets(ctx context.Context, userId string) ([]SyncTarget, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/Targets"
...
*/
func (a *SyncServiceApiService) HeadSyncJobitemsByIdFile(ctx context.Context, id string) (*http.Response, error) {
	var (
...
/*
SyncServiceApiService Gets sync status for an item.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *SyncServiceApiService) PostSyncByItemidStatus(ctx context.Context, body SyncedItemProgress, itemId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/{ItemId}/Status"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param targetId TargetId
 * @param optional nil or *SyncServiceApiPostSyncByTargetidItemsDeleteOpts - Optional Parameters:
     * @param "ItemIds" (optional.String) -  ItemIds
...
func (a *SyncServiceApiService) PostSyncByTargetidItemsDelete(ctx context.Context, targetId string, localVarOptionals *SyncServiceApiPostSyncByTargetidItemsDeleteOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/{TargetId}/Items/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"TargetId"+"}", fmt.Sprintf("%v", targetId), -1)
...
/*
SyncServiceApiService Syncs data between device and server
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *SyncServiceApiService) PostSyncData(ctx context.Context, body SyncDataRequest, targetId string) (SyncDataResponse, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/Data"
...
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SyncServiceApiPostSyncItemsCancelOpts - Optional Parameters:
     * @param "ItemIds" (optional.String) -  ItemIds
...
func (a *SyncServiceApiService) PostSyncItemsCancel(ctx context.Context, localVarOptionals *SyncServiceApiPostSyncItemsCancelOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/Items/Cancel"
...
func (a *SyncServiceApiService) PostSyncJobitemsByIdDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems/{Id}/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
SyncServiceApiService Enables a cancelled or queued sync job item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Id
...
func (a *SyncServiceApiService) PostSyncJobitemsByIdEnable(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems/{Id}/Enable"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
SyncServiceApiService Marks a job item for removal
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Id
...
func (a *SyncServiceApiService) PostSyncJobitemsByIdMarkforremoval(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems/{Id}/MarkForRemoval"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
SyncServiceApiService Reports that a sync job item has successfully been transferred.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Id
...
func (a *SyncServiceApiService) PostSyncJobitemsByIdTransferred(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems/{Id}/Transferred"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
SyncServiceApiService Unmarks a job item for removal
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Id
...
func (a *SyncServiceApiService) PostSyncJobitemsByIdUnmarkforremoval(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/JobItems/{Id}/UnmarkForRemoval"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
SyncServiceApiService Updates a sync job.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body SyncJob: 
 * @param id
...
func (a *SyncServiceApiService) PostSyncJobsByIdDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/Jobs/{Id}/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
SyncServiceApiService Reports an action that occurred while offline.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body List&#x60;1: 
...
func (a *SyncServiceApiService) PostSyncOfflineactions(ctx context.Context, body []UserAction) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Sync/OfflineActions"
