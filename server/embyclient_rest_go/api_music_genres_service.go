...
/*
MusicGenresServiceApiService Gets all music genres from a given item, folder, or the entire library
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MusicGenresServiceApiGetMusicgenresOpts - Optional Parameters:
...
func (a *MusicGenresServiceApiService) GetMusicgenres(ctx context.Context, localVarOptionals *MusicGenresServiceApiGetMusicgenresOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/MusicGenres"
...
/*
MusicGenresServiceApiService Gets a music genre, by name
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name The genre name
 * @param optional nil or *MusicGenresServiceApiGetMusicgenresByNameOpts - Optional Parameters:
...
func (a *MusicGenresServiceApiService) GetMusicgenresByName(ctx context.Context, name string, localVarOptionals *MusicGenresServiceApiGetMusicgenresByNameOpts) (BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/MusicGenres/{Name}"
