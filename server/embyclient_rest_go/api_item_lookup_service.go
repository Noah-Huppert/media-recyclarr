...
/*
ItemLookupServiceApiService Gets external id infos for an item
...
func (a *ItemLookupServiceApiService) GetItemsByIdExternalidinfos(ctx context.Context, id string) ([]ExternalIdInfo, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/ExternalIdInfos"
...
/*
ItemLookupServiceApiService Gets a remote image
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ItemLookupServiceApiService Resets metadata for one or more items
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param itemIds The item ids

*/
func (a *ItemLookupServiceApiService) PostItemsMetadataReset(ctx context.Context, itemIds string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/Metadata/Reset"
...
/*
ItemLookupServiceApiService Applies search criteria to an item and refreshes metadata
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body RemoteSearchResult: 
 * @param id The item id
 * @param optional nil or *ItemLookupServiceApiPostItemsRemotesearchApplyByIdOpts - Optional Parameters:
     * @param "ReplaceAllImages" (optional.Bool) -  Whether or not to replace all images
...
func (a *ItemLookupServiceApiService) PostItemsRemotesearchApplyById(ctx context.Context, body RemoteSearchResult, id string, localVarOptionals *ItemLookupServiceApiPostItemsRemotesearchApplyByIdOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/RemoteSearch/Apply/{Id}"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *ItemLookupServiceApiService) PostItemsRemotesearchGame(ctx context.Context, body RemoteSearchQueryGameInfo) ([]RemoteSearchResult, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/RemoteSearch/Game"
