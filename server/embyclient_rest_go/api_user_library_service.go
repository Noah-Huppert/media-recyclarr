...
/*
UserLibraryServiceApiService Unmarks an item as a favorite
...
func (a *UserLibraryServiceApiService) DeleteUsersByUseridFavoriteitemsById(ctx context.Context, userId string, id string) (UserItemDataDto, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/FavoriteItems/{Id}"
...
/*
UserLibraryServiceApiService Deletes a user&#x27;s saved personal rating for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param id Item Id
...
func (a *UserLibraryServiceApiService) DeleteUsersByUseridItemsByIdRating(ctx context.Context, userId string, id string) (UserItemDataDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Items/{Id}/Rating"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Gets a live tv program
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
@return BaseItemDto
...
func (a *UserLibraryServiceApiService) GetLivetvProgramsById(ctx context.Context, id string) (BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/LiveTv/Programs/{Id}"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Gets an item from a user&#x27;s library
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param id Item Id
...
func (a *UserLibraryServiceApiService) GetUsersByUseridItemsById(ctx context.Context, userId string, id string) (BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Items/{Id}"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Gets intros to play before the main media item plays
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param id Item Id
...
func (a *UserLibraryServiceApiService) GetUsersByUseridItemsByIdIntros(ctx context.Context, userId string, id string, localVarOptionals *UserLibraryServiceApiGetUsersByUseridItemsByIdIntrosOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Items/{Id}/Intros"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Gets local trailers for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param id Item Id
...
func (a *UserLibraryServiceApiService) GetUsersByUseridItemsByIdLocaltrailers(ctx context.Context, userId string, id string, localVarOptionals *UserLibraryServiceApiGetUsersByUseridItemsByIdLocaltrailersOpts) ([]BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Items/{Id}/LocalTrailers"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Gets special features for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param id Movie Id
...
func (a *UserLibraryServiceApiService) GetUsersByUseridItemsByIdSpecialfeatures(ctx context.Context, userId string, id string, localVarOptionals *UserLibraryServiceApiGetUsersByUseridItemsByIdSpecialfeaturesOpts) ([]BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Items/{Id}/SpecialFeatures"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Gets latest media
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param optional nil or *UserLibraryServiceApiGetUsersByUseridItemsLatestOpts - Optional Parameters:
     ...
     * @param "IsFolder" (optional.Bool) -  Filter by items that are folders, or not.
...
/*
UserLibraryServiceApiService Gets the root folder from a user&#x27;s library
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
@return BaseItemDto
...
/*
UserLibraryServiceApiService Gets additional parts for a video.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
...
func (a *UserLibraryServiceApiService) GetVideosByIdAdditionalparts(ctx context.Context, id string, localVarOptionals *UserLibraryServiceApiGetVideosByIdAdditionalpartsOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Videos/{Id}/AdditionalParts"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Updates user item access
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body UpdateUserItemAccess

*/
func (a *UserLibraryServiceApiService) PostItemsAccess(ctx context.Context, body UserLibraryUpdateUserItemAccess) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/Access"
...
/*
UserLibraryServiceApiService Makes an item private
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id

*/
func (a *UserLibraryServiceApiService) PostItemsByIdMakeprivate(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/MakePrivate"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Makes an item public to all users
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id

*/
func (a *UserLibraryServiceApiService) PostItemsByIdMakepublic(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/MakePublic"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Leaves a shared item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body LeaveSharedItems

*/
func (a *UserLibraryServiceApiService) PostItemsSharedLeave(ctx context.Context, body UserLibraryLeaveSharedItems) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/Shared/Leave"
...
/*
UserLibraryServiceApiService Marks an item as a favorite
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param id Item Id
...
func (a *UserLibraryServiceApiService) PostUsersByUseridFavoriteitemsByIdDelete(ctx context.Context, userId string, id string) (UserItemDataDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/FavoriteItems/{Id}/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserLibraryServiceApiService Updates a user&#x27;s hide from resume for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param id Item Id
...
func (a *UserLibraryServiceApiService) PostUsersByUseridItemsByIdHidefromresume(ctx context.Context, userId string, id string, hide bool) (UserItemDataDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Items/{Id}/HideFromResume"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
	...
	localVarQueryParams.Add("Hide", parameterToString(hide, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
UserLibraryServiceApiService Updates a user&#x27;s rating for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param id Item Id
...
func (a *UserLibraryServiceApiService) PostUsersByUseridItemsByIdRating(ctx context.Context, userId string, id string, likes bool) (UserItemDataDto, *http.Response, error) {
	...
	localVarQueryParams.Add("Likes", parameterToString(likes, ""))
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
func (a *UserLibraryServiceApiService) PostUsersByUseridItemsByIdRatingDelete(ctx context.Context, userId string, id string) (UserItemDataDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Items/{Id}/Rating/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
