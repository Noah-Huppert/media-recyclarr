...
/*
OfficialRatingServiceApiService Gets items based on a query.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *OfficialRatingServiceApiGetOfficialratingsOpts - Optional Parameters:
...
func (a *OfficialRatingServiceApiService) GetOfficialratings(ctx context.Context, localVarOptionals *OfficialRatingServiceApiGetOfficialratingsOpts) (QueryResultUserLibraryOfficialRatingItem, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/OfficialRatings"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v QueryResultUserLibraryOfficialRatingItem
