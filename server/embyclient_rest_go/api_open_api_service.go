...
/*
OpenApiServiceApiService Gets the OpenAPI 3 specifications
...
/*
OpenApiServiceApiService Gets OpenAPI 3 specifications
No authentication required
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return string
*/
func (a *OpenApiServiceApiService) GetOpenapiJson(ctx context.Context) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/openapi.json"
...
/*
OpenApiServiceApiService Gets the swagger specifications
No authentication required
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return string
*/
