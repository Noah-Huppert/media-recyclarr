...
*/
func (a *VideoHlsServiceApiService) GetAudioByIdHlsByPlaylistidBySegmentidBySegmentcontainer(ctx context.Context, segmentContainer string, segmentId string, id string, playlistId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Audio/{Id}/hls/{PlaylistId}/{SegmentId}.{SegmentContainer}"
