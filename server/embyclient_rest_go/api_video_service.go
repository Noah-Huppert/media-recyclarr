...
/*
VideoServiceApiService Gets a video stream
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param streamFileName
 * @param id Item Id
 * @param container Container
 * @param optional nil or *VideoServiceApiGetVideosByIdByStreamfilenameOpts - Optional Parameters:
...
type VideoServiceApiGetVideosByIdByStreamfilenameOpts struct {
...
func (a *VideoServiceApiService) GetVideosByIdByStreamfilename(ctx context.Context, streamFileName string, id string, container string, localVarOptionals *VideoServiceApiGetVideosByIdByStreamfilenameOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Videos/{Id}/{StreamFileName}"
 ...
 * @param id Item Id
 * @param container Container
 * @param optional nil or *VideoServiceApiGetVideosByIdStreamOpts - Optional Parameters:
     * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
     * @param "DeviceId" (optional.String) -  The device id of the client requesting. Used to stop encoding processes when needed.
     * @param "AudioCodec" (optional.String) -  Optional. Specify a audio codec to encode to, e.g. mp3. If omitted the server will auto-select using the url&#x27;s extension. Options: aac, mp3, vorbis, wma.
     * @param "EnableAutoStreamCopy" (optional.Bool) -  Whether or not to allow automatic stream copy if requested values match the original source. Defaults to true.
...
func (a *VideoServiceApiService) GetVideosByIdStream(ctx context.Context, id string, container string, localVarOptionals *VideoServiceApiGetVideosByIdStreamOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Videos/{Id}/stream"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param id Item Id
 * @param container Container
 * @param optional nil or *VideoServiceApiGetVideosByIdStreamByContainerOpts - Optional Parameters:
     * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
     * @param "DeviceId" (optional.String) -  The device id of the client requesting. Used to stop encoding processes when needed.
     * @param "AudioCodec" (optional.String) -  Optional. Specify a audio codec to encode to, e.g. mp3. If omitted the server will auto-select using the url&#x27;s extension. Options: aac, mp3, vorbis, wma.
     * @param "EnableAutoStreamCopy" (optional.Bool) -  Whether or not to allow automatic stream copy if requested values match the original source. Defaults to true.
...
func (a *VideoServiceApiService) GetVideosByIdStreamByContainer(ctx context.Context, id string, container string, localVarOptionals *VideoServiceApiGetVideosByIdStreamByContainerOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Videos/{Id}/stream.{Container}"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param id Item Id
 * @param container Container
 * @param optional nil or *VideoServiceApiHeadVideosByIdByStreamfilenameOpts - Optional Parameters:
     * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
     * @param "DeviceId" (optional.String) -  The device id of the client requesting. Used to stop encoding processes when needed.
     * @param "AudioCodec" (optional.String) -  Optional. Specify a audio codec to encode to, e.g. mp3. If omitted the server will auto-select using the url&#x27;s extension. Options: aac, mp3, vorbis, wma.
     * @param "EnableAutoStreamCopy" (optional.Bool) -  Whether or not to allow automatic stream copy if requested values match the original source. Defaults to true.
...
type VideoServiceApiHeadVideosByIdByStreamfilenameOpts struct {
    DeviceProfileId optional.String
    DeviceId optional.String
    AudioCodec optional.String
    EnableAutoStreamCopy optional.Bool
...
func (a *VideoServiceApiService) HeadVideosByIdByStreamfilename(ctx context.Context, streamFileName string, id string, container string, localVarOptionals *VideoServiceApiHeadVideosByIdByStreamfilenameOpts) (*http.Response, error) {
	var (
 ...
 * @param id Item Id
 * @param container Container
 * @param optional nil or *VideoServiceApiHeadVideosByIdStreamOpts - Optional Parameters:
     * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
     * @param "DeviceId" (optional.String) -  The device id of the client requesting. Used to stop encoding processes when needed.
     * @param "AudioCodec" (optional.String) -  Optional. Specify a audio codec to encode to, e.g. mp3. If omitted the server will auto-select using the url&#x27;s extension. Options: aac, mp3, vorbis, wma.
     * @param "EnableAutoStreamCopy" (optional.Bool) -  Whether or not to allow automatic stream copy if requested values match the original source. Defaults to true.
 ...
 * @param id Item Id
 * @param container Container
 * @param optional nil or *VideoServiceApiHeadVideosByIdStreamByContainerOpts - Optional Parameters:
     * @param "DeviceProfileId" (optional.String) -  Optional. The dlna device profile id to utilize.
     * @param "DeviceId" (optional.String) -  The device id of the client requesting. Used to stop encoding processes when needed.
     * @param "AudioCodec" (optional.String) -  Optional. Specify a audio codec to encode to, e.g. mp3. If omitted the server will auto-select using the url&#x27;s extension. Options: aac, mp3, vorbis, wma.
     * @param "EnableAutoStreamCopy" (optional.Bool) -  Whether or not to allow automatic stream copy if requested values match the original source. Defaults to true.
