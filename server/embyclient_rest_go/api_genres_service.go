...
/*
GenresServiceApiService Gets all genres from a given item, folder, or the entire library
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GenresServiceApiGetGenresOpts - Optional Parameters:
...
/*
GenresServiceApiService Gets a genre, by name
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name The genre name
 * @param optional nil or *GenresServiceApiGetGenresByNameOpts - Optional Parameters:
...
func (a *GenresServiceApiService) GetGenresByName(ctx context.Context, name string, localVarOptionals *GenresServiceApiGetGenresByNameOpts) (BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Genres/{Name}"
