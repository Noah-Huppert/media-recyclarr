...
/*
DeviceServiceApiService Deletes a device
...
func (a *DeviceServiceApiService) GetDevices(ctx context.Context, localVarOptionals *DeviceServiceApiGetDevicesOpts) (QueryResultDevicesDeviceInfo, *http.Response, error) {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v QueryResultDevicesDeviceInfo
...
func (a *DeviceServiceApiService) GetDevicesCamerauploads(ctx context.Context) (DevicesContentUploadHistory, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Devices/CameraUploads"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DevicesContentUploadHistory
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
DeviceServiceApiService Gets info for a device
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Device Id
...
/*
DeviceServiceApiService Gets options for a device
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Device Id
...
/*
DeviceServiceApiService Uploads content
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *DeviceServiceApiService) PostDevicesDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Devices/Delete"
...
/*
DeviceServiceApiService Updates device options
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
