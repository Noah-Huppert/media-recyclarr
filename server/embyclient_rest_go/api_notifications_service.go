 ...
 * @param optional nil or *NotificationsServiceApiPostNotificationsAdminOpts - Optional Parameters:
     * @param "ImageUrl" (optional.String) -  The notification&#x27;s image url
     * @param "Url" (optional.String) -  The notification&#x27;s info url
     * @param "Level" (optional.String) -  The notification level
