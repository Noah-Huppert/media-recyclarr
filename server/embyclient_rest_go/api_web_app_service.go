...
*/
func (a *WebAppServiceApiService) GetWebConfigurationpage(ctx context.Context) (*http.Response, error) {
	var (
...
*/
func (a *WebAppServiceApiService) GetWebStrings(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return []string
*/
func (a *WebAppServiceApiService) GetWebStringset(ctx context.Context) ([]string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/web/stringset"
