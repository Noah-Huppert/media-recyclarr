...
func (a *DlnaServerServiceApiService) GetDlnaByUuidConnectionmanagerConnectionmanager(ctx context.Context, uuId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/connectionmanager/connectionmanager"
...
func (a *DlnaServerServiceApiService) GetDlnaByUuidConnectionmanagerConnectionmanagerXml(ctx context.Context, uuId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/connectionmanager/connectionmanager.xml"
	localVarPath = strings.Replace(localVarPath, "{"+"UuId"+"}", fmt.Sprintf("%v", uuId), -1)
...
func (a *DlnaServerServiceApiService) GetDlnaByUuidContentdirectoryContentdirectory(ctx context.Context, uuId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/contentdirectory/contentdirectory"
	localVarPath = strings.Replace(localVarPath, "{"+"UuId"+"}", fmt.Sprintf("%v", uuId), -1)
...
func (a *DlnaServerServiceApiService) GetDlnaByUuidContentdirectoryContentdirectoryXml(ctx context.Context, uuId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/contentdirectory/contentdirectory.xml"
	localVarPath = strings.Replace(localVarPath, "{"+"UuId"+"}", fmt.Sprintf("%v", uuId), -1)
...
func (a *DlnaServerServiceApiService) GetDlnaByUuidDescription(ctx context.Context, uuId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/description"
	localVarPath = strings.Replace(localVarPath, "{"+"UuId"+"}", fmt.Sprintf("%v", uuId), -1)
...
func (a *DlnaServerServiceApiService) GetDlnaByUuidDescriptionXml(ctx context.Context, uuId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/description.xml"
	localVarPath = strings.Replace(localVarPath, "{"+"UuId"+"}", fmt.Sprintf("%v", uuId), -1)
...
func (a *DlnaServerServiceApiService) GetDlnaByUuidIconsByFilename(ctx context.Context, uuId string, filename string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/icons/{Filename}"
	localVarPath = strings.Replace(localVarPath, "{"+"UuId"+"}", fmt.Sprintf("%v", uuId), -1)
 ...
 * @param optional nil or *DlnaServerServiceApiGetDlnaIconsByFilenameOpts - Optional Parameters:
     * @param "UuId" (optional.String) -  Server UuId
...
*/
func (a *DlnaServerServiceApiService) HeadDlnaByUuidConnectionmanagerConnectionmanager(ctx context.Context, uuId string) (*http.Response, error) {
	var (
...
*/
func (a *DlnaServerServiceApiService) HeadDlnaByUuidConnectionmanagerConnectionmanagerXml(ctx context.Context, uuId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Head")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *DlnaServerServiceApiService) HeadDlnaByUuidContentdirectoryContentdirectory(ctx context.Context, uuId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Head")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *DlnaServerServiceApiService) HeadDlnaByUuidContentdirectoryContentdirectoryXml(ctx context.Context, uuId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Head")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *DlnaServerServiceApiService) HeadDlnaByUuidDescription(ctx context.Context, uuId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Head")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *DlnaServerServiceApiService) HeadDlnaByUuidDescriptionXml(ctx context.Context, uuId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Head")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *DlnaServerServiceApiService) PostDlnaByUuidConnectionmanagerControl(ctx context.Context, body Object, uuId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/connectionmanager/control"
	localVarPath = strings.Replace(localVarPath, "{"+"UuId"+"}", fmt.Sprintf("%v", uuId), -1)
...
func (a *DlnaServerServiceApiService) PostDlnaByUuidContentdirectoryControl(ctx context.Context, body Object, uuId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Dlna/{UuId}/contentdirectory/control"
	localVarPath = strings.Replace(localVarPath, "{"+"UuId"+"}", fmt.Sprintf("%v", uuId), -1)
