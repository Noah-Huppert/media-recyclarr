...
/*
UserServiceApiService Deletes a user
...
/*
UserServiceApiService Clears audio or subtitle track selections for a user
...
func (a *UserServiceApiService) DeleteUsersByIdTrackselectionsByTracktype(ctx context.Context, id string, trackType string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/TrackSelections/{TrackType}"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"TrackType"+"}", fmt.Sprintf("%v", trackType), -1)
...
/*
UserServiceApiService Gets a user by Id
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return UserDto
...
/*
UserServiceApiService Gets a typed user setting
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param key Key
 * @param userId
...
*/
func (a *UserServiceApiService) GetUsersByUseridTypedsettingsByKey(ctx context.Context, key string, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/TypedSettings/{Key}"
...
/*
UserServiceApiService Gets a list of users
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UserServiceApiGetUsersItemaccessOpts - Optional Parameters:
...
type UserServiceApiGetUsersItemaccessOpts struct {
...
func (a *UserServiceApiService) GetUsersItemaccess(ctx context.Context, localVarOptionals *UserServiceApiGetUsersItemaccessOpts) (QueryResultUserDto, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/ItemAccess"
...
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UserServiceApiGetUsersPrefixesOpts - Optional Parameters:
     * @param "IsHidden" (optional.Bool) -  Optional filter by IsHidden&#x3D;true or false
     * @param "IsDisabled" (optional.Bool) -  Optional filter by IsDisabled&#x3D;true or false
     * @param "StartIndex" (optional.Int32) -  Optional. The record index to start at. All items with a lower index will be dropped from the results.
     * @param "Limit" (optional.Int32) -  Optional. The maximum number of records to return
...
func (a *UserServiceApiService) GetUsersPrefixes(ctx context.Context, localVarOptionals *UserServiceApiGetUsersPrefixesOpts) ([]NameIdPair, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/Prefixes"
...
/*
UserServiceApiService Gets a list of publicly visible users for display on a login screen.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []UserDto
*/
...
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UserServiceApiGetUsersQueryOpts - Optional Parameters:
     * @param "IsHidden" (optional.Bool) -  Optional filter by IsHidden&#x3D;true or false
     * @param "IsDisabled" (optional.Bool) -  Optional filter by IsDisabled&#x3D;true or false
     * @param "StartIndex" (optional.Int32) -  Optional. The record index to start at. All items with a lower index will be dropped from the results.
     * @param "Limit" (optional.Int32) -  Optional. The maximum number of records to return
...
/*
UserServiceApiService Authenticates a user
...
func (a *UserServiceApiService) PostUsersAuthenticatebyname(ctx context.Context, body AuthenticateUserByName, xEmbyAuthorization string) (AuthenticationAuthenticationResult, *http.Response, error) {
	...
	localVarHeaderParams["X-Emby-Authorization"] = parameterToString(xEmbyAuthorization, "")
	// body params
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AuthenticationAuthenticationResult
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
UserServiceApiService Updates a user
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body UserDto: 
 * @param id
...
func (a *UserServiceApiService) PostUsersByIdAuthenticate(ctx context.Context, body AuthenticateUser, id string) (AuthenticationAuthenticationResult, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/Authenticate"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserServiceApiService Updates a user configuration
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *UserServiceApiService) PostUsersByIdConfiguration(ctx context.Context, body UserConfiguration, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/Configuration"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
*/
func (a *UserServiceApiService) PostUsersByIdConfigurationPartial(ctx context.Context, body Object, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/Configuration/Partial"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *UserServiceApiService) PostUsersByIdDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserServiceApiService Updates a user&#x27;s password
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
UserServiceApiService Updates a user policy
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *UserServiceApiService) PostUsersByIdPolicy(ctx context.Context, body UserPolicy, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/Policy"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *UserServiceApiService) PostUsersByIdTrackselectionsByTracktypeDelete(ctx context.Context, id string, trackType string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/TrackSelections/{TrackType}/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"TrackType"+"}", fmt.Sprintf("%v", trackType), -1)
...
/*
UserServiceApiService Updates a typed user setting
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body Binary stream
 * @param userId
...
*/
func (a *UserServiceApiService) PostUsersByUseridTypedsettingsByKey(ctx context.Context, body Object, userId string, key string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
UserServiceApiService Initiates the forgot password process for a local user
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
UserServiceApiService Redeems a forgot password pin
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
UserServiceApiService Creates a user
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
