...
/*
ArtistsServiceApiService Gets all artists from a given item, folder, or the entire library
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ArtistsServiceApiGetArtistsOpts - Optional Parameters:
...
/*
ArtistsServiceApiService Gets all album artists from a given item, folder, or the entire library
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ArtistsServiceApiGetArtistsAlbumartistsOpts - Optional Parameters:
     * @param "ArtistType" (optional.String) -  Artist or AlbumArtist
     * @param "MaxOfficialRating" (optional.String) -  Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
     * @param "HasThemeSong" (optional.Bool) -  Optional filter by items with theme songs.
     * @param "HasThemeVideo" (optional.Bool) -  Optional filter by items with theme videos.
...
/*
ArtistsServiceApiService Gets an artist, by name
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name The artist name
 * @param optional nil or *ArtistsServiceApiGetArtistsByNameOpts - Optional Parameters:
