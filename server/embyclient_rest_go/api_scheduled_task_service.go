...
/*
ScheduledTaskServiceApiService Stops a scheduled task
...
func (a *ScheduledTaskServiceApiService) DeleteScheduledtasksRunningById(ctx context.Context, id string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/ScheduledTasks/Running/{Id}"
...
/*
ScheduledTaskServiceApiService Gets scheduled tasks
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
ScheduledTaskServiceApiService Gets a scheduled task, by Id
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
@return TaskInfo
...
func (a *ScheduledTaskServiceApiService) GetScheduledtasksById(ctx context.Context, id string) (TaskInfo, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ScheduledTasks/{Id}"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ScheduledTaskServiceApiService Updates the triggers for a scheduled task
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body List&#x60;1: 
 * @param id
...
func (a *ScheduledTaskServiceApiService) PostScheduledtasksByIdTriggers(ctx context.Context, body []TaskTriggerInfo, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ScheduledTasks/{Id}/Triggers"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
ScheduledTaskServiceApiService Starts a scheduled task
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
...
func (a *ScheduledTaskServiceApiService) PostScheduledtasksRunningByIdDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ScheduledTasks/Running/{Id}/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
