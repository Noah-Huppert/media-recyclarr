...
/*
PersonsServiceApiService Gets all persons from a given item, folder, or the entire library
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PersonsServiceApiGetPersonsOpts - Optional Parameters:
...
/*
PersonsServiceApiService Gets a person, by name
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name The person name
 * @param optional nil or *PersonsServiceApiGetPersonsByNameOpts - Optional Parameters:
...
func (a *PersonsServiceApiService) GetPersonsByName(ctx context.Context, name string, localVarOptionals *PersonsServiceApiGetPersonsByNameOpts) (BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Persons/{Name}"
