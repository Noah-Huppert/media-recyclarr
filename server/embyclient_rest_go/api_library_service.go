...
/*
LibraryServiceApiService Deletes an item from the library and file system
...
/*
LibraryServiceApiService Finds albums similar to a given album.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetAlbumsByIdSimilarOpts - Optional Parameters:
...
func (a *LibraryServiceApiService) GetAlbumsByIdSimilar(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetAlbumsByIdSimilarOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Albums/{Id}/Similar"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetArtistsByIdSimilarOpts - Optional Parameters:
     * @param "IncludeItemTypes" (optional.String) -  Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
     * @param "EnableImages" (optional.Bool) -  Optional, include image information in output
     * @param "EnableUserData" (optional.Bool) -  Optional, include user data
     * @param "ImageTypeLimit" (optional.Int32) -  Optional, the max number of images to return, per image type
...
func (a *LibraryServiceApiService) GetArtistsByIdSimilar(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetArtistsByIdSimilarOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Artists/{Id}/Similar"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Finds games similar to a given game.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetGamesByIdSimilarOpts - Optional Parameters:
     * @param "IncludeItemTypes" (optional.String) -  Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
     * @param "EnableImages" (optional.Bool) -  Optional, include image information in output
     * @param "EnableUserData" (optional.Bool) -  Optional, include user data
     * @param "ImageTypeLimit" (optional.Int32) -  Optional, the max number of images to return, per image type
...
func (a *LibraryServiceApiService) GetGamesByIdSimilar(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetGamesByIdSimilarOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Games/{Id}/Similar"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Gets all parents of an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetItemsByIdAncestorsOpts - Optional Parameters:
     * @param "UserId" (optional.String) -  Optional. Filter by user id, and attach user data
@return []BaseItemDto
*/
...
func (a *LibraryServiceApiService) GetItemsByIdAncestors(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetItemsByIdAncestorsOpts) ([]BaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/Ancestors"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Gets critic reviews for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetItemsByIdCriticreviewsOpts - Optional Parameters:
...
func (a *LibraryServiceApiService) GetItemsByIdCriticreviews(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetItemsByIdCriticreviewsOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/CriticReviews"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Gets delete info for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
...
func (a *LibraryServiceApiService) GetItemsByIdDeleteinfo(ctx context.Context, id string) (LibraryDeleteInfo, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/DeleteInfo"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Downloads item media
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
...
func (a *LibraryServiceApiService) GetItemsByIdDownload(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/Download"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Gets the original file of an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
...
func (a *LibraryServiceApiService) GetItemsByIdFile(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/File"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Gets similar items
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetItemsByIdSimilarOpts - Optional Parameters:
     * @param "IncludeItemTypes" (optional.String) -  Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
     * @param "EnableImages" (optional.Bool) -  Optional, include image information in output
     * @param "EnableUserData" (optional.Bool) -  Optional, include user data
     * @param "ImageTypeLimit" (optional.Int32) -  Optional, the max number of images to return, per image type
...
func (a *LibraryServiceApiService) GetItemsByIdSimilar(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetItemsByIdSimilarOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/Similar"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Gets theme videos and songs for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
...
func (a *LibraryServiceApiService) GetItemsByIdThememedia(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetItemsByIdThememediaOpts) (AllThemeMediaResult, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/ThemeMedia"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Gets theme songs for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
...
func (a *LibraryServiceApiService) GetItemsByIdThemesongs(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetItemsByIdThemesongsOpts) (ThemeMediaResult, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/ThemeSongs"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Gets theme videos for an item
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
...
func (a *LibraryServiceApiService) GetItemsByIdThemevideos(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetItemsByIdThemevideosOpts) (ThemeMediaResult, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/ThemeVideos"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LibraryServiceApiGetItemsCountsOpts - Optional Parameters:
     * @param "UserId" (optional.String) -  Optional. Get counts from a specific user&#x27;s library.
...
/*
LibraryServiceApiService Gets info to debug intros
...
func (a *LibraryServiceApiService) GetItemsIntros(ctx context.Context) ([]PersistenceIntroDebugInfo, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/Intros"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []PersistenceIntroDebugInfo
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
LibraryServiceApiService Gets all user media folders.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LibraryServiceApiGetLibraryMediafoldersOpts - Optional Parameters:
...
/*
LibraryServiceApiService Gets a list of physical paths from virtual folders
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []string
*/
...
func (a *LibraryServiceApiService) GetLibrarySelectablemediafolders(ctx context.Context) ([]LibraryMediaFolder, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Library/SelectableMediaFolders"
...
/*
LibraryServiceApiService Finds movies and trailers similar to a given movie.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetMoviesByIdSimilarOpts - Optional Parameters:
     * @param "IncludeItemTypes" (optional.String) -  Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
     * @param "EnableImages" (optional.Bool) -  Optional, include image information in output
     * @param "EnableUserData" (optional.Bool) -  Optional, include user data
     * @param "ImageTypeLimit" (optional.Int32) -  Optional, the max number of images to return, per image type
...
func (a *LibraryServiceApiService) GetMoviesByIdSimilar(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetMoviesByIdSimilarOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Movies/{Id}/Similar"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Finds tv shows similar to a given one.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetShowsByIdSimilarOpts - Optional Parameters:
     * @param "IncludeItemTypes" (optional.String) -  Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
     * @param "EnableImages" (optional.Bool) -  Optional, include image information in output
     * @param "EnableUserData" (optional.Bool) -  Optional, include user data
     * @param "ImageTypeLimit" (optional.Int32) -  Optional, the max number of images to return, per image type
...
func (a *LibraryServiceApiService) GetShowsByIdSimilar(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetShowsByIdSimilarOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Shows/{Id}/Similar"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
LibraryServiceApiService Finds movies and trailers similar to a given trailer.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Item Id
 * @param optional nil or *LibraryServiceApiGetTrailersByIdSimilarOpts - Optional Parameters:
     * @param "IncludeItemTypes" (optional.String) -  Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
     * @param "EnableImages" (optional.Bool) -  Optional, include image information in output
     * @param "EnableUserData" (optional.Bool) -  Optional, include user data
     * @param "ImageTypeLimit" (optional.Int32) -  Optional, the max number of images to return, per image type
...
func (a *LibraryServiceApiService) GetTrailersByIdSimilar(ctx context.Context, id string, localVarOptionals *LibraryServiceApiGetTrailersByIdSimilarOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Trailers/{Id}/Similar"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *LibraryServiceApiService) PostItemsByIdDelete(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/{Id}/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *LibraryServiceApiService) PostItemsDelete(ctx context.Context, ids string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Items/Delete"
...
/*
LibraryServiceApiService Reports that new movies have been added by an external source
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
LibraryServiceApiService Deprecated. Use /Library/Media/Updated
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
LibraryServiceApiService Starts a library scan
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
