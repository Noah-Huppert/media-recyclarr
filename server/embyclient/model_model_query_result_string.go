...
// checks if the ModelQueryResultString type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelQueryResultString{}

// ModelQueryResultString struct for ModelQueryResultString
type ModelQueryResultString struct {
...
func (o ModelQueryResultString) MarshalJSON() ([]byte, error) {
...
func (o ModelQueryResultString) ToMap() (map[string]interface{}, error) {
...
type NullableModelQueryResultString struct {
	value *ModelQueryResultString
	isSet bool
}

func (v NullableModelQueryResultString) Get() *ModelQueryResultString {
	return v.value
}

func (v *NullableModelQueryResultString) Set(val *ModelQueryResultString) {
	v.value = val
	v.isSet = true
}

func (v NullableModelQueryResultString) IsSet() bool {
	return v.isSet
}

func (v *NullableModelQueryResultString) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelQueryResultString(val *ModelQueryResultString) *NullableModelQueryResultString {
	return &NullableModelQueryResultString{value: val, isSet: true}
}

func (v NullableModelQueryResultString) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelQueryResultString) UnmarshalJSON(src []byte) error {
	v.isSet = true
