...
// checks if the ModelItemLookupInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelItemLookupInfo{}

// ModelItemLookupInfo struct for ModelItemLookupInfo
type ModelItemLookupInfo struct {
...
func (o *ModelItemLookupInfo) GetMetadataLanguages() []ModelGlobalizationCultureDto {
...
// and a boolean to check if the value has been set.
func (o *ModelItemLookupInfo) GetMetadataLanguagesOk() ([]ModelGlobalizationCultureDto, bool) {
	if o == nil || IsNil(o.MetadataLanguages) {
		return nil, false
	}
...
func (o *ModelItemLookupInfo) SetMetadataLanguages(v []ModelGlobalizationCultureDto) {
...
func (o *ModelItemLookupInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *ModelItemLookupInfo) SetIndexNumberNil() {
...
func (o *ModelItemLookupInfo) SetParentIndexNumberNil() {
...
func (o *ModelItemLookupInfo) SetPremiereDateNil() {
...
func (o ModelItemLookupInfo) MarshalJSON() ([]byte, error) {
...
func (o ModelItemLookupInfo) ToMap() (map[string]interface{}, error) {
...
type NullableModelItemLookupInfo struct {
	value *ModelItemLookupInfo
	isSet bool
}

func (v NullableModelItemLookupInfo) Get() *ModelItemLookupInfo {
	return v.value
}

func (v *NullableModelItemLookupInfo) Set(val *ModelItemLookupInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableModelItemLookupInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableModelItemLookupInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelItemLookupInfo(val *ModelItemLookupInfo) *NullableModelItemLookupInfo {
	return &NullableModelItemLookupInfo{value: val, isSet: true}
}

func (v NullableModelItemLookupInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelItemLookupInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
