...
/*
SystemServiceApiService Gets information about the request endpoint
...
/*
SystemServiceApiService Gets information about the server
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return SystemInfo
*/
...
/*
SystemServiceApiService Gets a log file
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name The log file name.
 * @param optional nil or *SystemServiceApiGetSystemLogsByNameOpts - Optional Parameters:
     * @param "Sanitize" (optional.Bool) -  Return sanitized log
...
func (a *SystemServiceApiService) GetSystemLogsByName(ctx context.Context, name string, localVarOptionals *SystemServiceApiGetSystemLogsByNameOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/System/Logs/{Name}"
	...
	if localVarOptionals != nil && localVarOptionals.Sanitize.IsSet() {
		localVarQueryParams.Add("Sanitize", parameterToString(localVarOptionals.Sanitize.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
func (a *SystemServiceApiService) GetSystemLogsByNameLines(ctx context.Context, name string) (QueryResultString, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/System/Logs/{Name}/Lines"
	localVarPath = strings.Replace(localVarPath, "{"+"Name"+"}", fmt.Sprintf("%v", name), -1)
...
/*
SystemServiceApiService Gets a list of available server log files
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SystemServiceApiGetSystemLogsQueryOpts - Optional Parameters:
...
func (a *SystemServiceApiService) GetSystemLogsQuery(ctx context.Context, localVarOptionals *SystemServiceApiGetSystemLogsQueryOpts) (QueryResultLogFile, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/System/Logs/Query"
...
func (a *SystemServiceApiService) GetSystemReleasenotes(ctx context.Context) (PackageVersionInfo, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/System/ReleaseNotes"
...
func (a *SystemServiceApiService) GetSystemReleasenotesVersions(ctx context.Context) ([]PackageVersionInfo, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/System/ReleaseNotes/Versions"
...
/*
SystemServiceApiService Gets wake on lan information
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
SystemServiceApiService Restarts the application, if needed
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
SystemServiceApiService Shuts down the application
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
