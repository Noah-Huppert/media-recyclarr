...
// APIClient manages communication with the Emby Server REST API (BETA) API v4.8.0.61
...
type APIClient struct {
	...
	UserActivityAPIAPI *UserActivityAPIAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.UserActivityAPIAPI = (*UserActivityAPIAPIService)(&c.common)
