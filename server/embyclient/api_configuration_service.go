...
/*
ConfigurationServiceApiService Gets application configuration
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ServerConfiguration
*/
func (a *ConfigurationServiceApiService) GetSystemConfiguration(ctx context.Context) (ServerConfiguration, *http.Response, error) {
	var (
...
/*
ConfigurationServiceApiService Gets a named configuration
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param key Key
...
*/
func (a *ConfigurationServiceApiService) PostSystemConfiguration(ctx context.Context, body ServerConfiguration) (*http.Response, error) {
	var (
...
/*
ConfigurationServiceApiService Updates named configuration
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *ConfigurationServiceApiService) PostSystemConfigurationPartial(ctx context.Context, body ServerConfiguration) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/System/Configuration/Partial"
