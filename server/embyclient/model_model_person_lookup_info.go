...
// checks if the ModelPersonLookupInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelPersonLookupInfo{}

// ModelPersonLookupInfo struct for ModelPersonLookupInfo
type ModelPersonLookupInfo struct {
...
func (o *ModelPersonLookupInfo) GetMetadataLanguages() []ModelGlobalizationCultureDto {
...
// and a boolean to check if the value has been set.
func (o *ModelPersonLookupInfo) GetMetadataLanguagesOk() ([]ModelGlobalizationCultureDto, bool) {
	if o == nil || IsNil(o.MetadataLanguages) {
		return nil, false
	}
...
func (o *ModelPersonLookupInfo) SetMetadataLanguages(v []ModelGlobalizationCultureDto) {
...
func (o *ModelPersonLookupInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *ModelPersonLookupInfo) SetIndexNumberNil() {
...
func (o *ModelPersonLookupInfo) SetParentIndexNumberNil() {
...
func (o *ModelPersonLookupInfo) SetPremiereDateNil() {
...
func (o ModelPersonLookupInfo) MarshalJSON() ([]byte, error) {
...
func (o ModelPersonLookupInfo) ToMap() (map[string]interface{}, error) {
...
type NullableModelPersonLookupInfo struct {
	value *ModelPersonLookupInfo
	isSet bool
}

func (v NullableModelPersonLookupInfo) Get() *ModelPersonLookupInfo {
	return v.value
}

func (v *NullableModelPersonLookupInfo) Set(val *ModelPersonLookupInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableModelPersonLookupInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableModelPersonLookupInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelPersonLookupInfo(val *ModelPersonLookupInfo) *NullableModelPersonLookupInfo {
	return &NullableModelPersonLookupInfo{value: val, isSet: true}
}

func (v NullableModelPersonLookupInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelPersonLookupInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
