...
// checks if the ModelTrailerInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelTrailerInfo{}

// ModelTrailerInfo struct for ModelTrailerInfo
type ModelTrailerInfo struct {
...
func (o *ModelTrailerInfo) GetMetadataLanguages() []ModelGlobalizationCultureDto {
...
// and a boolean to check if the value has been set.
func (o *ModelTrailerInfo) GetMetadataLanguagesOk() ([]ModelGlobalizationCultureDto, bool) {
	if o == nil || IsNil(o.MetadataLanguages) {
		return nil, false
	}
...
func (o *ModelTrailerInfo) SetMetadataLanguages(v []ModelGlobalizationCultureDto) {
...
func (o *ModelTrailerInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *ModelTrailerInfo) SetIndexNumberNil() {
...
func (o *ModelTrailerInfo) SetParentIndexNumberNil() {
...
func (o *ModelTrailerInfo) SetPremiereDateNil() {
...
func (o ModelTrailerInfo) MarshalJSON() ([]byte, error) {
...
func (o ModelTrailerInfo) ToMap() (map[string]interface{}, error) {
...
type NullableModelTrailerInfo struct {
	value *ModelTrailerInfo
	isSet bool
}

func (v NullableModelTrailerInfo) Get() *ModelTrailerInfo {
	return v.value
}

func (v *NullableModelTrailerInfo) Set(val *ModelTrailerInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableModelTrailerInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableModelTrailerInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelTrailerInfo(val *ModelTrailerInfo) *NullableModelTrailerInfo {
	return &NullableModelTrailerInfo{value: val, isSet: true}
}

func (v NullableModelTrailerInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelTrailerInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
