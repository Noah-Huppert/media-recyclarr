...
type StudiosServiceAPIGetStudiosRequest struct {
	ctx context.Context
	ApiService *StudiosServiceAPIService
	artistType *string
...
func (r StudiosServiceAPIGetStudiosRequest) ArtistType(artistType string) StudiosServiceAPIGetStudiosRequest {
	r.artistType = &artistType
	return r
}

// Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
func (r StudiosServiceAPIGetStudiosRequest) MaxOfficialRating(maxOfficialRating string) StudiosServiceAPIGetStudiosRequest {
	r.maxOfficialRating = &maxOfficialRating
	return r
}

// Optional filter by items with theme songs.
func (r StudiosServiceAPIGetStudiosRequest) HasThemeSong(hasThemeSong bool) StudiosServiceAPIGetStudiosRequest {
	r.hasThemeSong = &hasThemeSong
	return r
}

// Optional filter by items with theme videos.
func (r StudiosServiceAPIGetStudiosRequest) HasThemeVideo(hasThemeVideo bool) StudiosServiceAPIGetStudiosRequest {
	r.hasThemeVideo = &hasThemeVideo
	return r
}

// Optional filter by items with subtitles.
func (r StudiosServiceAPIGetStudiosRequest) HasSubtitles(hasSubtitles bool) StudiosServiceAPIGetStudiosRequest {
	r.hasSubtitles = &hasSubtitles
	return r
}

// Optional filter by items with special features.
func (r StudiosServiceAPIGetStudiosRequest) HasSpecialFeature(hasSpecialFeature bool) StudiosServiceAPIGetStudiosRequest {
	r.hasSpecialFeature = &hasSpecialFeature
	return r
}

// Optional filter by items with trailers.
func (r StudiosServiceAPIGetStudiosRequest) HasTrailer(hasTrailer bool) StudiosServiceAPIGetStudiosRequest {
	r.hasTrailer = &hasTrailer
	return r
}

// Optional. Return items that are siblings of a supplied item.
func (r StudiosServiceAPIGetStudiosRequest) AdjacentTo(adjacentTo string) StudiosServiceAPIGetStudiosRequest {
	r.adjacentTo = &adjacentTo
	return r
}

// Optional filter by minimum index number.
func (r StudiosServiceAPIGetStudiosRequest) MinIndexNumber(minIndexNumber int32) StudiosServiceAPIGetStudiosRequest {
	r.minIndexNumber = &minIndexNumber
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r StudiosServiceAPIGetStudiosRequest) MinStartDate(minStartDate string) StudiosServiceAPIGetStudiosRequest {
	r.minStartDate = &minStartDate
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r StudiosServiceAPIGetStudiosRequest) MaxStartDate(maxStartDate string) StudiosServiceAPIGetStudiosRequest {
	r.maxStartDate = &maxStartDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r StudiosServiceAPIGetStudiosRequest) MinEndDate(minEndDate string) StudiosServiceAPIGetStudiosRequest {
	r.minEndDate = &minEndDate
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r StudiosServiceAPIGetStudiosRequest) MaxEndDate(maxEndDate string) StudiosServiceAPIGetStudiosRequest {
	r.maxEndDate = &maxEndDate
	return r
}

// Optional filter by minimum number of game players.
func (r StudiosServiceAPIGetStudiosRequest) MinPlayers(minPlayers int32) StudiosServiceAPIGetStudiosRequest {
	r.minPlayers = &minPlayers
	return r
}

// Optional filter by maximum number of game players.
func (r StudiosServiceAPIGetStudiosRequest) MaxPlayers(maxPlayers int32) StudiosServiceAPIGetStudiosRequest {
	r.maxPlayers = &maxPlayers
	return r
}

// Optional filter by parent index number.
func (r StudiosServiceAPIGetStudiosRequest) ParentIndexNumber(parentIndexNumber int32) StudiosServiceAPIGetStudiosRequest {
	r.parentIndexNumber = &parentIndexNumber
	return r
}

// Optional filter by items that have or do not have a parental rating
func (r StudiosServiceAPIGetStudiosRequest) HasParentalRating(hasParentalRating bool) StudiosServiceAPIGetStudiosRequest {
	r.hasParentalRating = &hasParentalRating
	return r
}

// Optional filter by items that are HD or not.
func (r StudiosServiceAPIGetStudiosRequest) IsHD(isHD bool) StudiosServiceAPIGetStudiosRequest {
	r.isHD = &isHD
	return r
}

// Optional filter by items that are unaired episodes or not.
func (r StudiosServiceAPIGetStudiosRequest) IsUnaired(isUnaired bool) StudiosServiceAPIGetStudiosRequest {
	r.isUnaired = &isUnaired
	return r
}

// Optional filter by minimum community rating.
func (r StudiosServiceAPIGetStudiosRequest) MinCommunityRating(minCommunityRating float64) StudiosServiceAPIGetStudiosRequest {
	r.minCommunityRating = &minCommunityRating
	return r
}

// Optional filter by minimum critic rating.
func (r StudiosServiceAPIGetStudiosRequest) MinCriticRating(minCriticRating float64) StudiosServiceAPIGetStudiosRequest {
	r.minCriticRating = &minCriticRating
	return r
}

// Gets all episodes that aired during a season, including specials.
func (r StudiosServiceAPIGetStudiosRequest) AiredDuringSeason(airedDuringSeason int32) StudiosServiceAPIGetStudiosRequest {
	r.airedDuringSeason = &airedDuringSeason
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r StudiosServiceAPIGetStudiosRequest) MinPremiereDate(minPremiereDate string) StudiosServiceAPIGetStudiosRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r StudiosServiceAPIGetStudiosRequest) MinDateLastSaved(minDateLastSaved string) StudiosServiceAPIGetStudiosRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r StudiosServiceAPIGetStudiosRequest) MinDateLastSavedForUser(minDateLastSavedForUser string) StudiosServiceAPIGetStudiosRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r StudiosServiceAPIGetStudiosRequest) MaxPremiereDate(maxPremiereDate string) StudiosServiceAPIGetStudiosRequest {
	r.maxPremiereDate = &maxPremiereDate
	return r
}

// Optional filter by items that have an overview or not.
func (r StudiosServiceAPIGetStudiosRequest) HasOverview(hasOverview bool) StudiosServiceAPIGetStudiosRequest {
	r.hasOverview = &hasOverview
	return r
}

// Optional filter by items that have an imdb id or not.
func (r StudiosServiceAPIGetStudiosRequest) HasImdbId(hasImdbId bool) StudiosServiceAPIGetStudiosRequest {
	r.hasImdbId = &hasImdbId
	return r
}

// Optional filter by items that have a tmdb id or not.
func (r StudiosServiceAPIGetStudiosRequest) HasTmdbId(hasTmdbId bool) StudiosServiceAPIGetStudiosRequest {
	r.hasTmdbId = &hasTmdbId
	return r
}

// Optional filter by items that have a tvdb id or not.
func (r StudiosServiceAPIGetStudiosRequest) HasTvdbId(hasTvdbId bool) StudiosServiceAPIGetStudiosRequest {
...
func (r StudiosServiceAPIGetStudiosRequest) ExcludeItemIds(excludeItemIds string) StudiosServiceAPIGetStudiosRequest {
	r.excludeItemIds = &excludeItemIds
	return r
}

// Optional. The record index to start at. All items with a lower index will be dropped from the results.
func (r StudiosServiceAPIGetStudiosRequest) StartIndex(startIndex int32) StudiosServiceAPIGetStudiosRequest {
	r.startIndex = &startIndex
	return r
}

// Optional. The maximum number of records to return
func (r StudiosServiceAPIGetStudiosRequest) Limit(limit int32) StudiosServiceAPIGetStudiosRequest {
	r.limit = &limit
	return r
}

// When searching within folders, this determines whether or not the search will be recursive. true/false
func (r StudiosServiceAPIGetStudiosRequest) Recursive(recursive bool) StudiosServiceAPIGetStudiosRequest {
	r.recursive = &recursive
	return r
}

// Enter a search term to perform a search request
func (r StudiosServiceAPIGetStudiosRequest) SearchTerm(searchTerm string) StudiosServiceAPIGetStudiosRequest {
	r.searchTerm = &searchTerm
	return r
}

// Sort Order - Ascending,Descending
func (r StudiosServiceAPIGetStudiosRequest) SortOrder(sortOrder string) StudiosServiceAPIGetStudiosRequest {
	r.sortOrder = &sortOrder
	return r
}

// Specify this to localize the search to a specific item or folder. Omit to use the root
func (r StudiosServiceAPIGetStudiosRequest) ParentId(parentId string) StudiosServiceAPIGetStudiosRequest {
	r.parentId = &parentId
	return r
}
...
func (r StudiosServiceAPIGetStudiosRequest) Fields(fields string) StudiosServiceAPIGetStudiosRequest {
	r.fields = &fields
	return r
}

// Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) ExcludeItemTypes(excludeItemTypes string) StudiosServiceAPIGetStudiosRequest {
	r.excludeItemTypes = &excludeItemTypes
	return r
}

// Optional. If specified, results will be filtered based on item type. This allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) IncludeItemTypes(includeItemTypes string) StudiosServiceAPIGetStudiosRequest {
...
func (r StudiosServiceAPIGetStudiosRequest) AnyProviderIdEquals(anyProviderIdEquals string) StudiosServiceAPIGetStudiosRequest {
...
func (r StudiosServiceAPIGetStudiosRequest) Filters(filters string) StudiosServiceAPIGetStudiosRequest {
	r.filters = &filters
	return r
}

// Optional filter by items that are marked as favorite, or not.
func (r StudiosServiceAPIGetStudiosRequest) IsFavorite(isFavorite bool) StudiosServiceAPIGetStudiosRequest {
	r.isFavorite = &isFavorite
	return r
}

// Optional filter for movies.
func (r StudiosServiceAPIGetStudiosRequest) IsMovie(isMovie bool) StudiosServiceAPIGetStudiosRequest {
	r.isMovie = &isMovie
	return r
}

// Optional filter for series.
func (r StudiosServiceAPIGetStudiosRequest) IsSeries(isSeries bool) StudiosServiceAPIGetStudiosRequest {
	r.isSeries = &isSeries
	return r
}

// Optional filter for folders.
func (r StudiosServiceAPIGetStudiosRequest) IsFolder(isFolder bool) StudiosServiceAPIGetStudiosRequest {
	r.isFolder = &isFolder
	return r
}

// Optional filter for news.
func (r StudiosServiceAPIGetStudiosRequest) IsNews(isNews bool) StudiosServiceAPIGetStudiosRequest {
	r.isNews = &isNews
	return r
}

// Optional filter for kids.
func (r StudiosServiceAPIGetStudiosRequest) IsKids(isKids bool) StudiosServiceAPIGetStudiosRequest {
	r.isKids = &isKids
	return r
}

// Optional filter for sports.
func (r StudiosServiceAPIGetStudiosRequest) IsSports(isSports bool) StudiosServiceAPIGetStudiosRequest {
	r.isSports = &isSports
	return r
}

// Optional filter for IsNew.
func (r StudiosServiceAPIGetStudiosRequest) IsNew(isNew bool) StudiosServiceAPIGetStudiosRequest {
	r.isNew = &isNew
	return r
}

// Optional filter for IsPremiere.
func (r StudiosServiceAPIGetStudiosRequest) IsPremiere(isPremiere bool) StudiosServiceAPIGetStudiosRequest {
	r.isPremiere = &isPremiere
	return r
}

// Optional filter for IsNewOrPremiere.
func (r StudiosServiceAPIGetStudiosRequest) IsNewOrPremiere(isNewOrPremiere bool) StudiosServiceAPIGetStudiosRequest {
	r.isNewOrPremiere = &isNewOrPremiere
	return r
}

// Optional filter for IsRepeat.
func (r StudiosServiceAPIGetStudiosRequest) IsRepeat(isRepeat bool) StudiosServiceAPIGetStudiosRequest {
	r.isRepeat = &isRepeat
	return r
}

// ProjectToMedia
func (r StudiosServiceAPIGetStudiosRequest) ProjectToMedia(projectToMedia bool) StudiosServiceAPIGetStudiosRequest {
	r.projectToMedia = &projectToMedia
	return r
}

// Optional filter by MediaType. Allows multiple, comma delimited.
func (r StudiosServiceAPIGetStudiosRequest) MediaTypes(mediaTypes string) StudiosServiceAPIGetStudiosRequest {
	r.mediaTypes = &mediaTypes
	return r
}

// Optional. If specified, results will be filtered based on those containing image types. This allows multiple, comma delimited.
func (r StudiosServiceAPIGetStudiosRequest) ImageTypes(imageTypes string) StudiosServiceAPIGetStudiosRequest {
...
func (r StudiosServiceAPIGetStudiosRequest) SortBy(sortBy string) StudiosServiceAPIGetStudiosRequest {
	r.sortBy = &sortBy
	return r
}

// Optional filter by items that are played, or not.
func (r StudiosServiceAPIGetStudiosRequest) IsPlayed(isPlayed bool) StudiosServiceAPIGetStudiosRequest {
	r.isPlayed = &isPlayed
	return r
}

// Optional. If specified, results will be filtered based on genre. This allows multiple, pipe delimeted.
func (r StudiosServiceAPIGetStudiosRequest) Genres(genres string) StudiosServiceAPIGetStudiosRequest {
	r.genres = &genres
	return r
}

// Optional. If specified, results will be filtered based on OfficialRating. This allows multiple, pipe delimeted.
func (r StudiosServiceAPIGetStudiosRequest) OfficialRatings(officialRatings string) StudiosServiceAPIGetStudiosRequest {
...
func (r StudiosServiceAPIGetStudiosRequest) Tags(tags string) StudiosServiceAPIGetStudiosRequest {
	r.tags = &tags
	return r
}

// Optional. If specified, results will be filtered based on tag. This allows multiple, pipe delimeted.
func (r StudiosServiceAPIGetStudiosRequest) ExcludeTags(excludeTags string) StudiosServiceAPIGetStudiosRequest {
...
func (r StudiosServiceAPIGetStudiosRequest) Years(years string) StudiosServiceAPIGetStudiosRequest {
	r.years = &years
	return r
}

// Optional, include image information in output
func (r StudiosServiceAPIGetStudiosRequest) EnableImages(enableImages bool) StudiosServiceAPIGetStudiosRequest {
	r.enableImages = &enableImages
	return r
}

// Optional, include user data
func (r StudiosServiceAPIGetStudiosRequest) EnableUserData(enableUserData bool) StudiosServiceAPIGetStudiosRequest {
	r.enableUserData = &enableUserData
	return r
}

// Optional, the max number of images to return, per image type
func (r StudiosServiceAPIGetStudiosRequest) ImageTypeLimit(imageTypeLimit int32) StudiosServiceAPIGetStudiosRequest {
	r.imageTypeLimit = &imageTypeLimit
	return r
}

// Optional. The image types to include in the output.
func (r StudiosServiceAPIGetStudiosRequest) EnableImageTypes(enableImageTypes string) StudiosServiceAPIGetStudiosRequest {
	r.enableImageTypes = &enableImageTypes
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified person.
func (r StudiosServiceAPIGetStudiosRequest) Person(person string) StudiosServiceAPIGetStudiosRequest {
	r.person = &person
	return r
}

// Optional. If specified, results will be filtered to include only those containing the specified person.
func (r StudiosServiceAPIGetStudiosRequest) PersonIds(personIds string) StudiosServiceAPIGetStudiosRequest {
	r.personIds = &personIds
	return r
}

// Optional. If specified, along with Person, results will be filtered to include only those containing the specified person and PersonType. Allows multiple, comma-delimited
func (r StudiosServiceAPIGetStudiosRequest) PersonTypes(personTypes string) StudiosServiceAPIGetStudiosRequest {
...
func (r StudiosServiceAPIGetStudiosRequest) Studios(studios string) StudiosServiceAPIGetStudiosRequest {
	r.studios = &studios
	return r
}

// Optional. If specified, results will be filtered based on studio. This allows multiple, pipe delimeted.
func (r StudiosServiceAPIGetStudiosRequest) StudioIds(studioIds string) StudiosServiceAPIGetStudiosRequest {
	r.studioIds = &studioIds
	return r
}

// Optional. If specified, results will be filtered based on artist. This allows multiple, pipe delimeted.
func (r StudiosServiceAPIGetStudiosRequest) Artists(artists string) StudiosServiceAPIGetStudiosRequest {
	r.artists = &artists
	return r
}

// Optional. If specified, results will be filtered based on artist. This allows multiple, pipe delimeted.
func (r StudiosServiceAPIGetStudiosRequest) ArtistIds(artistIds string) StudiosServiceAPIGetStudiosRequest {
	r.artistIds = &artistIds
	return r
}

// Optional. If specified, results will be filtered based on album. This allows multiple, pipe delimeted.
func (r StudiosServiceAPIGetStudiosRequest) Albums(albums string) StudiosServiceAPIGetStudiosRequest {
	r.albums = &albums
	return r
}

// Optional. If specific items are needed, specify a list of item id&#39;s to retrieve. This allows multiple, comma delimited.
func (r StudiosServiceAPIGetStudiosRequest) Ids(ids string) StudiosServiceAPIGetStudiosRequest {
	r.ids = &ids
	return r
}

// Optional filter by VideoType (videofile, dvd, bluray, iso). Allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) VideoTypes(videoTypes string) StudiosServiceAPIGetStudiosRequest {
	r.videoTypes = &videoTypes
	return r
}

// Optional filter by Container. Allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) Containers(containers string) StudiosServiceAPIGetStudiosRequest {
	r.containers = &containers
	return r
}

// Optional filter by AudioCodec. Allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) AudioCodecs(audioCodecs string) StudiosServiceAPIGetStudiosRequest {
	r.audioCodecs = &audioCodecs
	return r
}

// Optional filter by AudioLayout. Allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) AudioLayouts(audioLayouts string) StudiosServiceAPIGetStudiosRequest {
	r.audioLayouts = &audioLayouts
	return r
}

// Optional filter by VideoCodec. Allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) VideoCodecs(videoCodecs string) StudiosServiceAPIGetStudiosRequest {
	r.videoCodecs = &videoCodecs
	return r
}

// Optional filter by ExtendedVideoType. Allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) ExtendedVideoTypes(extendedVideoTypes string) StudiosServiceAPIGetStudiosRequest {
	r.extendedVideoTypes = &extendedVideoTypes
	return r
}

// Optional filter by SubtitleCodec. Allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) SubtitleCodecs(subtitleCodecs string) StudiosServiceAPIGetStudiosRequest {
	r.subtitleCodecs = &subtitleCodecs
	return r
}

// Optional filter by Path.
func (r StudiosServiceAPIGetStudiosRequest) Path(path string) StudiosServiceAPIGetStudiosRequest {
	r.path = &path
	return r
}

// User Id
func (r StudiosServiceAPIGetStudiosRequest) UserId(userId string) StudiosServiceAPIGetStudiosRequest {
	r.userId = &userId
	return r
}

// Optional filter by minimum official rating (PG, PG-13, TV-MA, etc).
func (r StudiosServiceAPIGetStudiosRequest) MinOfficialRating(minOfficialRating string) StudiosServiceAPIGetStudiosRequest {
	r.minOfficialRating = &minOfficialRating
	return r
}

// Optional filter by items that are locked.
func (r StudiosServiceAPIGetStudiosRequest) IsLocked(isLocked bool) StudiosServiceAPIGetStudiosRequest {
	r.isLocked = &isLocked
	return r
}

// Optional filter by items that are placeholders
func (r StudiosServiceAPIGetStudiosRequest) IsPlaceHolder(isPlaceHolder bool) StudiosServiceAPIGetStudiosRequest {
	r.isPlaceHolder = &isPlaceHolder
	return r
}

// Optional filter by items that have official ratings
func (r StudiosServiceAPIGetStudiosRequest) HasOfficialRating(hasOfficialRating bool) StudiosServiceAPIGetStudiosRequest {
	r.hasOfficialRating = &hasOfficialRating
	return r
}

// Whether or not to hide items behind their boxsets.
func (r StudiosServiceAPIGetStudiosRequest) GroupItemsIntoCollections(groupItemsIntoCollections bool) StudiosServiceAPIGetStudiosRequest {
	r.groupItemsIntoCollections = &groupItemsIntoCollections
	return r
}

// Optional filter by items that are 3D, or not.
func (r StudiosServiceAPIGetStudiosRequest) Is3D(is3D bool) StudiosServiceAPIGetStudiosRequest {
	r.is3D = &is3D
	return r
}

// Optional filter by Series Status. Allows multiple, comma delimeted.
func (r StudiosServiceAPIGetStudiosRequest) SeriesStatus(seriesStatus string) StudiosServiceAPIGetStudiosRequest {
	r.seriesStatus = &seriesStatus
	return r
}

// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r StudiosServiceAPIGetStudiosRequest) NameStartsWithOrGreater(nameStartsWithOrGreater string) StudiosServiceAPIGetStudiosRequest {
	r.nameStartsWithOrGreater = &nameStartsWithOrGreater
	return r
}

// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r StudiosServiceAPIGetStudiosRequest) ArtistStartsWithOrGreater(artistStartsWithOrGreater string) StudiosServiceAPIGetStudiosRequest {
	r.artistStartsWithOrGreater = &artistStartsWithOrGreater
	return r
}

// Optional filter by items whose name is sorted equally or greater than a given input string.
func (r StudiosServiceAPIGetStudiosRequest) AlbumArtistStartsWithOrGreater(albumArtistStartsWithOrGreater string) StudiosServiceAPIGetStudiosRequest {
	r.albumArtistStartsWithOrGreater = &albumArtistStartsWithOrGreater
	return r
}

// Optional filter by items whose name is sorted equally than a given input string.
func (r StudiosServiceAPIGetStudiosRequest) NameStartsWith(nameStartsWith string) StudiosServiceAPIGetStudiosRequest {
	r.nameStartsWith = &nameStartsWith
	return r
}

// Optional filter by items whose name is equally or lesser than a given input string.
func (r StudiosServiceAPIGetStudiosRequest) NameLessThan(nameLessThan string) StudiosServiceAPIGetStudiosRequest {
	r.nameLessThan = &nameLessThan
	return r
}

func (r StudiosServiceAPIGetStudiosRequest) Execute() (*ModelQueryResultBaseItemDto, *http.Response, error) {
...
Requires authentication as user
 ...
 @return StudiosServiceAPIGetStudiosRequest
*/
func (a *StudiosServiceAPIService) GetStudios(ctx context.Context) StudiosServiceAPIGetStudiosRequest {
	return StudiosServiceAPIGetStudiosRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *StudiosServiceAPIService) GetStudiosExecute(r StudiosServiceAPIGetStudiosRequest) (*ModelQueryResultBaseItemDto, *http.Response, error) {
	var (
...
type StudiosServiceAPIGetStudiosByNameRequest struct {
	ctx context.Context
	ApiService *StudiosServiceAPIService
	name string
	userId *string
...
func (r StudiosServiceAPIGetStudiosByNameRequest) UserId(userId string) StudiosServiceAPIGetStudiosByNameRequest {
	r.userId = &userId
	return r
}

func (r StudiosServiceAPIGetStudiosByNameRequest) Execute() (*ModelBaseItemDto, *http.Response, error) {
...
Requires authentication as user
 ...
 @return StudiosServiceAPIGetStudiosByNameRequest
*/
func (a *StudiosServiceAPIService) GetStudiosByName(ctx context.Context, name string) StudiosServiceAPIGetStudiosByNameRequest {
	return StudiosServiceAPIGetStudiosByNameRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
func (a *StudiosServiceAPIService) GetStudiosByNameExecute(r StudiosServiceAPIGetStudiosByNameRequest) (*ModelBaseItemDto, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
