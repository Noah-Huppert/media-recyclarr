...
func main() {
	...
	// response from `GetPersons`: ModelModelQueryResultBaseItemDto
...
> ModelModelBaseItemDto GetPersonsByName(ctx, name).UserId(userId).Execute()
...
func main() {
	...
	// response from `GetPersonsByName`: ModelModelBaseItemDto
