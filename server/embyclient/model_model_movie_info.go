...
// checks if the ModelMovieInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelMovieInfo{}

// ModelMovieInfo struct for ModelMovieInfo
type ModelMovieInfo struct {
...
func (o *ModelMovieInfo) GetMetadataLanguages() []ModelGlobalizationCultureDto {
...
// and a boolean to check if the value has been set.
func (o *ModelMovieInfo) GetMetadataLanguagesOk() ([]ModelGlobalizationCultureDto, bool) {
	if o == nil || IsNil(o.MetadataLanguages) {
		return nil, false
	}
...
func (o *ModelMovieInfo) SetMetadataLanguages(v []ModelGlobalizationCultureDto) {
...
func (o *ModelMovieInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *ModelMovieInfo) SetIndexNumberNil() {
...
func (o *ModelMovieInfo) SetParentIndexNumberNil() {
...
func (o *ModelMovieInfo) SetPremiereDateNil() {
...
func (o ModelMovieInfo) MarshalJSON() ([]byte, error) {
...
func (o ModelMovieInfo) ToMap() (map[string]interface{}, error) {
...
type NullableModelMovieInfo struct {
	value *ModelMovieInfo
	isSet bool
}

func (v NullableModelMovieInfo) Get() *ModelMovieInfo {
	return v.value
}

func (v *NullableModelMovieInfo) Set(val *ModelMovieInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableModelMovieInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableModelMovieInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelMovieInfo(val *ModelMovieInfo) *NullableModelMovieInfo {
	return &NullableModelMovieInfo{value: val, isSet: true}
}

func (v NullableModelMovieInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelMovieInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
