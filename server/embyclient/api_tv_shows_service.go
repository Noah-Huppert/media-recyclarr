...
/*
TvShowsServiceApiService Gets a list of missing episodes
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *TvShowsServiceApiGetShowsMissingOpts - Optional Parameters:
     * @param "ArtistType" (optional.String) -  Artist or AlbumArtist
     * @param "MaxOfficialRating" (optional.String) -  Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
     * @param "HasThemeSong" (optional.Bool) -  Optional filter by items with theme songs.
     * @param "HasThemeVideo" (optional.Bool) -  Optional filter by items with theme videos.
...
type TvShowsServiceApiGetShowsMissingOpts struct {
    ArtistType optional.String
    MaxOfficialRating optional.String
    HasThemeSong optional.Bool
    HasThemeVideo optional.Bool
...
func (a *TvShowsServiceApiService) GetShowsMissing(ctx context.Context, localVarOptionals *TvShowsServiceApiGetShowsMissingOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Shows/Missing"
...
func (a *TvShowsServiceApiService) GetShowsUpcoming(ctx context.Context, localVarOptionals *TvShowsServiceApiGetShowsUpcomingOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
