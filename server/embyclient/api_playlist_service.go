...
/*
PlaylistServiceApiService Removes items from a playlist
...
func (a *PlaylistServiceApiService) DeletePlaylistsByIdItems(ctx context.Context, id string, entryIds string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/Playlists/{Id}/Items"
	...
	localVarQueryParams.Add("EntryIds", parameterToString(entryIds, ""))
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *PlaylistServiceApiGetPlaylistsByIdItemsOpts - Optional Parameters:
     * @param "UserId" (optional.String) -  User Id
...
/*
PlaylistServiceApiService Creates a new playlist
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PlaylistServiceApiPostPlaylistsOpts - Optional Parameters:
     * @param "Name" (optional.String) -  The name of the new playlist.
     * @param "Ids" (optional.String) -  Item Ids to add to the playlist
     * @param "MediaType" (optional.String) -  The playlist media type
...
func (a *PlaylistServiceApiService) PostPlaylists(ctx context.Context, localVarOptionals *PlaylistServiceApiPostPlaylistsOpts) (PlaylistsPlaylistCreationResult, *http.Response, error) {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v PlaylistsPlaylistCreationResult
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
PlaylistServiceApiService Adds items to a playlist
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ids Item id, comma delimited
 * @param id
...
func (a *PlaylistServiceApiService) PostPlaylistsByIdItemsByItemidMoveByNewindex(ctx context.Context, itemId int64, id string, newIndex int32) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Playlists/{Id}/Items/{ItemId}/Move/{NewIndex}"
	localVarPath = strings.Replace(localVarPath, "{"+"ItemId"+"}", fmt.Sprintf("%v", itemId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"NewIndex"+"}", fmt.Sprintf("%v", newIndex), -1)
...
func (a *PlaylistServiceApiService) PostPlaylistsByIdItemsDelete(ctx context.Context, id string, entryIds string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Playlists/{Id}/Items/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
