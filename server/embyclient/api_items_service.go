...
/*
ItemsServiceApiService Gets items based on a query.
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ItemsServiceApiGetItemsOpts - Optional Parameters:
 ...
 * @param optional nil or *ItemsServiceApiGetUsersByUseridItemsOpts - Optional Parameters:
     * @param "ArtistType" (optional.String) -  Artist or AlbumArtist
     * @param "MaxOfficialRating" (optional.String) -  Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
     * @param "HasThemeSong" (optional.Bool) -  Optional filter by items with theme songs.
     * @param "HasThemeVideo" (optional.Bool) -  Optional filter by items with theme videos.
...
func (a *ItemsServiceApiService) GetUsersByUseridItems(ctx context.Context, userId string, localVarOptionals *ItemsServiceApiGetUsersByUseridItemsOpts) (QueryResultBaseItemDto, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Items"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
 * @param optional nil or *ItemsServiceApiGetUsersByUseridItemsResumeOpts - Optional Parameters:
     * @param "ArtistType" (optional.String) -  Artist or AlbumArtist
     * @param "MaxOfficialRating" (optional.String) -  Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
     * @param "HasThemeSong" (optional.Bool) -  Optional filter by items with theme songs.
     * @param "HasThemeVideo" (optional.Bool) -  Optional filter by items with theme videos.
